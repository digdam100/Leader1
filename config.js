...
const config = {
    ...
    sources: {
        tweets: {
            url: 'https://raw.githubusercontent.com/digdam10-sketch/digdam10/refs/heads/main/tweets.txt',
            fallback: path.join(ROOT_DIR, 'tweets.txt'),
        },
        retweets: {
            url: 'https://raw.githubusercontent.com/digdam10-sketch/digdam10/refs/heads/main/retweets.txt',
            fallback: path.join(ROOT_DIR, 'retweets.txt'),
        },
        media: {
            url: 'https://raw.githubusercontent.com/digdam10-sketch/digdam10/refs/heads/main/media.txt',
            fallback: path.join(ROOT_DIR, 'media.txt'),
        },
        hashtags: {
            url: 'https://raw.githubusercontent.com/digdam10-sketch/digdam10/refs/heads/main/hashtags.txt',
